...
if (isset($_POST['AddPost'])) {
 ...
 if (empty($Image)) {
    ...
    $sql = "INSERT INTO   img_gallery(category,image,text)";
      ...
      <div class="container-fluid">
          ...
          <div class="col-12">
            <div class="card" style="overflow: auto;" >
              <div class="card-header">
                <h3 class="card-title">All  Gallery post  &nbsp;<strong>(<?php TotalImageGallery(); ?>)</strong> </h3> <span class="" style="float: right;"><button class="btn btn-success" type="button" data-toggle="modal" data-target="#modal-default" > Add <i class="fas fa-plus"></i></button></span>
              </div>
              <?php 
                  echo ErrorMessage();
                  echo SuccessMessage(); 
       ...
       ?>
                  ...
                  <tr>
                   ...
                   <td><a href="../images/gallery/<?php echo htmlentities($Image); ?>"><img src="../images/gallery/<?php echo htmlentities($Image); ?>" style="width: 80px; height: 80px;"></a></td>
