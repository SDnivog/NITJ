...
if (isset($_POST['AddPost'])) {
  ...
  $Target = "../pdf_files/".basename($_FILES['Image']['name']);
 ...
 if (empty($Image)) {
    ...
    $sql = "INSERT INTO   heighlights(title,category,file)";
    $sql .= "VALUES(:TitLe,:ADedEd,:ImaGeS)";
    $stmt = $ConnectingDB->prepare($sql);
    $stmt->bindValue(':TitLe', $Title);
    $stmt->bindValue(':ADedEd', $Category);
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add Heighlight post</h4>
                ...
                <div class="card-body">
                  <form method="post" action="#" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" id="name" name="title" class="form-control" placeholder="Enter image caption..." required="">
                    </div>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Heighlights</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
          ...
          <div class="col-12">
            <div class="card" style="overflow: auto;" >
              <div class="card-header">
                <h3 class="card-title">All heighlights posts  &nbsp;<strong>(<?php TotalHeighlights(); ?>)</strong> </h3> <span class="" style="float: right;"><button class="btn btn-success" type="button" data-toggle="modal" data-target="#modal-default" > Add <i class="fas fa-plus"></i></button></span>
              </div>
              <?php 
                  echo ErrorMessage();
                  echo SuccessMessage(); 
       ...
       ?>
                  ...
                  <tr>
                   ...
                   <td><a href="../pdf_files/<?php echo htmlentities($File); ?>"><?php echo htmlentities($File); ?></a></td>
