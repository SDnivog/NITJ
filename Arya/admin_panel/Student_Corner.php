...
if (isset($_POST['AddPost'])) {
 ...
 if (empty($Image)) {
    ...
    $sql = "INSERT INTO  student_corner(title,category,file)";
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add Student Corner post</h4>
          ...
          <div class="col-12">
            <div class="card" style="overflow: auto;" >
              <div class="card-header">
                <h3 class="card-title">All Student Corner post  &nbsp;<strong>(<?php TotalStudentCorner(); ?>)</strong> </h3> <span class="" style="float: right;"><button class="btn btn-success" type="button" data-toggle="modal" data-target="#modal-default" > Add <i class="fas fa-plus"></i></button></span>
              </div>
              <?php 
                  echo ErrorMessage();
                  echo SuccessMessage(); 
