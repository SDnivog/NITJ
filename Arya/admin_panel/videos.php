...
if (isset($_POST['AddCat'])) {
 ...
 if (empty($Url)) {
    ...
    $sql = "INSERT INTO  video_gallery(url,category)";
    $sql .= "VALUES(:TitLe,:ADedEd)";
    $stmt = $ConnectingDB->prepare($sql);
    $stmt->bindValue(':TitLe', $Url);
    $stmt->bindValue(':ADedEd', $Title);
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add new video gallery post </h4>
                ...
                <div class="card-body">
                  <form method="post" action="#">
                    <div class="form-group">
                      ...
                      <input type="text" id="name" name="url" class="form-control" placeholder="Enter video url..." required="">
                    </div>
                    <div class="form-group">
          ...
          <div class="col-12">
            <div class="card" style="overflow: auto;" >
              <div class="card-header">
                <h3 class="card-title">All Video Gallery Posts &nbsp;<strong>(<?php TotalCategory(); ?>)</strong> </h3> <span class="" style="float: right;"><button class="btn btn-success" type="button" data-toggle="modal" data-target="#modal-default" > Add <i class="fas fa-plus"></i></button></span>
              </div>
              <?php 
                  echo ErrorMessage();
                  echo SuccessMessage(); 
