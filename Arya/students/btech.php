...
<h5 class="py-2 ml-2">All B.Tech students of all batches</h5>	
...
<div class="card">
	<div class="card-header">All Batch 2017 B.Tech Students</div>
...
<?php
    global $ConnectingDB;
              $sql = "SELECT * FROM  students where course = 'B.Tech' AND yearr = '2017' ";
...
<?php } ?>
    ...
    <div class="tab-pane fade" id="b2020" role="tabpanel" aria-labelledby="profile-tab">
  	<div class="card">
	<div class="card-header">All Batch 2018 B.Tech Students</div>
	<div class="card-body" style="overflow: scroll;">
		  	<table class="table table-bordered" >
  <thead>
    <tr>
...
<?php
    global $ConnectingDB;
              $sql = "SELECT * FROM  students where course = 'B.Tech' AND yearr = '2018' ";
              $Execute = $ConnectingDB->query($sql);
              $SrNo = 0;
              while ($DataRows=$Execute->fetch()) {
...
<?php } ?>
  ...
  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
  	<div class="card">
	<div class="card-header">All Batch 2019 B.Tech Students</div>
	<div class="card-body" style="overflow: scroll;">
		  	<table class="table table-bordered" >
  <thead>
    <tr>
...
<?php
    global $ConnectingDB;
              $sql = "SELECT * FROM  students where course = 'B.Tech' AND yearr = '2019' ";
              $Execute = $ConnectingDB->query($sql);
              $SrNo = 0;
              while ($DataRows=$Execute->fetch()) {
...
<?php } ?>
  ...
  <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
  	<div class="card">
	<div class="card-header">All Batch 2020 B.Tech Students</div>
	<div class="card-body" style="overflow: scroll;">
		  	<table class="table table-bordered" >
  <thead>
    <tr>
  ...
  <?php
    global $ConnectingDB;
              $sql = "SELECT * FROM  students where course = 'B.Tech' AND yearr = '2020' ";
              $Execute = $ConnectingDB->query($sql);
              $SrNo = 0;
              while ($DataRows=$Execute->fetch()) {
